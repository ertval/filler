...
## Corpus Check
- 96 files · ~54,583 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 869 nodes · 986 edges · 105 communities (84 shown, 21 thin omitted)
...
## Knowledge Gaps
- **430 isolated node(s):** `$schema`, `plugin`, `@opencode-ai/plugin`, `viz.sh script`, `run_game.sh script` (+425 more)
