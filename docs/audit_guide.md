...
# Verify game_engine and robots exist
...
**Check:** Bot only places pieces with exactly 1 own-cell overlap and 0 opponent overlap. Invalid moves cause game engine to reject.
...
**Check:** Student wins ≥8/10 total (≥4/5 of relevant games).
...
make test               # All tests
make test-e2e           # E2E replay (needs game_engine)
make bench              # Performance benchmark
make audit              # Full automated audit suite
make docker-build       # Docker image
make play MAP=map01 P1=filler P2=bender VIS=0
```
